...
#Enable Warning IDE1006 ' Naming Styles
        If txtLorryNo.Text IsNot ("") Then
            Form1.btnHold5.Text = txtLorryNo.Text
        Else
            Form1.btnHold5.Text = "On Hold 5"
        End If
        Me.Hide()
        Form1.btnHold5.BackColor = Color.Yellow
    End Sub
    ...
    Private Sub Form6_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Form1.btnHold5.Text = "New"
        Form1.btnHold5.BackColor = Color.MediumTurquoise
        If (Form1.lblCount5.Text IsNot "") Then
            counter1 = Convert.ToInt32(Form1.lblCount5.Text)
            totalcount = counter1 + Counter
            Form1.lblCount5.Text = totalcount
            Form1.lblPosting5.Visible = True
        Else
            Form1.lblCount5.Text = Counter
            Form1.lblPosting5.Visible = True
        End If
    End Sub
End Class