...
#Enable Warning IDE1006 ' Naming Styles
        If txtLorryNo.Text IsNot ("") Then
            Form1.btnHold2.Text = txtLorryNo.Text
        Else
            Form1.btnHold2.Text = "On Hold 2"
        End If
        Form1.btnHold2.BackColor = Color.Yellow
        Me.Hide()
    End Sub
    ...
    Private Sub Form3_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Form1.btnHold2.Text = "New"
        Form1.btnHold2.BackColor = Color.MediumTurquoise
        If (Form1.lblCount2.Text IsNot "") Then
            counter1 = Convert.ToInt32(Form1.lblCount2.Text)
            totalcount = counter1 + Counter
            Form1.lblCount2.Text = totalcount
            Form1.lblPosting2.Visible = True
        Else
            Form1.lblCount2.Text = Counter
            Form1.lblPosting2.Visible = True
        End If
    End Sub
