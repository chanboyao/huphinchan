...
#Enable Warning IDE1006 ' Naming Styles
        If txtLorryNo.Text IsNot ("") Then
            Form1.btnHold4.Text = txtLorryNo.Text
        Else
            Form1.btnHold4.Text = "On Hold 4"
        End If
        Me.Hide()
        Form1.btnHold4.BackColor = Color.Yellow
    End Sub
    ...
    Private Sub Form5_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Form1.btnHold4.Text = "New"
        Form1.btnHold4.BackColor = Color.MediumTurquoise
        If (Form1.lblCount4.Text IsNot "") Then
            counter1 = Convert.ToInt32(Form1.lblCount4.Text)
            totalcount = counter1 + Counter
            Form1.lblCount4.Text = totalcount
            Form1.lblPosting4.Visible = True
        Else
            Form1.lblCount4.Text = Counter
            Form1.lblPosting4.Visible = True
        End If
    End Sub
End Class