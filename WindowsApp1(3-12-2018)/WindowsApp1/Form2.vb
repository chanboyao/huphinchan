Public Class Form2
    ...
    Dim counter1, totalcount As Integer
    Dim Subsidi As Double
...
#Enable Warning IDE1006 ' Naming Styles
        If e.KeyCode = Keys.Enter Then
            If txtProduct.Text IsNot ("") Then
                Product = txtProduct.Text.ToUpper
                GetInfo()
                txtBags.Select()
            Else
        ...
        If e.KeyCode = Keys.Enter Then
            If IsNumeric(txtPrice.Text) Then
                ...
                If TotalDisc < 100 Then
                    ...
                    Subsidi = NetWeight * 0.3
                    txtSubsidi.Text = Subsidi
                    txtAmount.Select()
                Else
                    MessageBox.Show("Invalid percentage! Please try again.", "Invalid number!", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                    txtKotor.Text = ""
...
#Enable Warning BC42105 ' Function doesn't return a value on all code paths
    ...
    Function GetInfo()
        ...
        RptObject.Params.Find("ItemData").Value = Product.ToUpper
...
#Enable Warning IDE1006 ' Naming Styles
        If txtAmount.Text IsNot ("") Then
            ...
            Bags = txtBags.Text
            TotalBerat = txtTotal.Text
            TotalDisc = txtPotongan.Text
            Basah = txtBasah.Text
            Kotor = txtKotor.Text
            Muda = txtMuda.Text
            Lain = txtLain.Text
...
#Enable Warning IDE1006 ' Naming Styles
        If txtLorryNo.Text IsNot ("") Then
            Form1.btnHold1.Text = txtLorryNo.Text
        Else
            Form1.btnHold1.Text = "On Hold 1"
        End If
        Me.Hide()
        Form1.btnHold1.BackColor = Color.Yellow
    End Sub
    ...
    Private Sub Form2_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Form1.btnHold1.Text = "New"
        Form1.btnHold1.BackColor = Color.MediumTurquoise
        If (Form1.lblCount1.Text IsNot "") Then
            counter1 = Convert.ToInt32(Form1.lblCount1.Text)
            totalcount = counter1 + Counter
            Form1.lblCount1.Text = totalcount
            Form1.lblPosting1.Visible = True
        Else
            Form1.lblCount1.Text = Counter
            Form1.lblPosting1.Visible = True
        End If
    End Sub
